...
; This file was generated Sun Jul 20 08:45:33 2014
;--------------------------------------------------------
	.module owi_detect_presence
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_detect_presence_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_detect_presence'
;------------------------------------------------------------
;owi_pin_id                Allocated with name '_owi_detect_presence_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_detect_presence.c:47: uint8_t owi_detect_presence(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_detect_presence
;	-----------------------------------------
_owi_detect_presence:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_detect_presence_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_detect_presence.c:50: delay_us(OWI_DELAY_G);
	mov	dptr,#0x0000
	lcall	_delay_us
;	src/owi_detect_presence.c:53: gpio_pin_dir_output(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_OUTPUT_BUFFER_NORMAL_DRIVE_STRENGTH);
	mov	dptr,#_owi_detect_presence_owi_pin_id_1_47
	movx	a,@dptr
	mov	r7,a
	...
	mov	dpl,r7
	push	ar7
	lcall	_gpio_pin_dir_output
;	src/owi_detect_presence.c:54: delay_us(OWI_DELAY_H);
	mov	dptr,#0x01E0
	lcall	_delay_us
	pop	ar7
;	src/owi_detect_presence.c:57: gpio_pin_dir_input(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_INPUT_BUFFER_ON_PULL_UP_RESISTOR);
	mov	dptr,#_gpio_pin_dir_input_PARM_2
	mov	a,#0x40
	movx	@dptr,a
	mov	dpl,r7
	push	ar7
	lcall	_gpio_pin_dir_input
;	src/owi_detect_presence.c:58: delay_us(OWI_DELAY_I);
	mov	dptr,#0x0050
	lcall	_delay_us
	pop	ar7
;	src/owi_detect_presence.c:61: if (gpio_pin_val_read(owi_pin_id))
	mov	dpl,r7
	lcall	_gpio_pin_val_read
	mov	a,dpl
	jz	00102$
;	src/owi_detect_presence.c:63: delay_us(OWI_DELAY_J);
	mov	dptr,#0x0190
	lcall	_delay_us
;	src/owi_detect_presence.c:64: return 1;
	mov	dpl,#0x01
	ret
00102$:
;	src/owi_detect_presence.c:68: delay_us(OWI_DELAY_J);
	mov	dptr,#0x0190
	lcall	_delay_us
;	src/owi_detect_presence.c:69: return 0;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
