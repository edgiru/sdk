...
_timer2_calc_actual_period_PARM_2:
	.ds 1
_timer2_calc_actual_period_crc_val_1_11:
	.ds 2
;--------------------------------------------------------
...
;crc_val                   Allocated with name '_timer2_calc_actual_period_crc_val_1_11'
;------------------------------------------------------------
...
_timer2_calc_actual_period:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_timer2_calc_actual_period_crc_val_1_11
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
