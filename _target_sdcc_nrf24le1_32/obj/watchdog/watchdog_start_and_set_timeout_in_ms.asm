...
; This file was generated Sun Jul 20 08:46:41 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_watchdog_start_and_set_timeout_in_ms_milliseconds_1_9:
	.ds 4
_watchdog_start_and_set_timeout_in_ms_wd_value_1_10:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;milliseconds              Allocated with name '_watchdog_start_and_set_timeout_in_ms_milliseconds_1_9'
;wd_value                  Allocated with name '_watchdog_start_and_set_timeout_in_ms_wd_value_1_10'
;------------------------------------------------------------
...
_watchdog_start_and_set_timeout_in_ms:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_milliseconds_1_9
	mov	a,r7
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	src/watchdog_start_and_set_timeout_in_ms.c:52: uint16_t wd_value = 0;
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_wd_value_1_10
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
