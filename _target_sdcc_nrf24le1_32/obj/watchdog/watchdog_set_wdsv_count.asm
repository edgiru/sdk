...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_watchdog_set_wdsv_count_wdsv_value_1_3:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;wdsv_value                Allocated with name '_watchdog_set_wdsv_count_wdsv_value_1_3'
;------------------------------------------------------------
...
_watchdog_set_wdsv_count:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_watchdog_set_wdsv_count_wdsv_value_1_3
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
