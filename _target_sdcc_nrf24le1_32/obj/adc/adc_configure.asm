...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_configure_adc_config_options_1_5:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_config_options        Allocated with name '_adc_configure_adc_config_options_1_5'
;------------------------------------------------------------
...
_adc_configure:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_adc_configure_adc_config_options_1_5
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
