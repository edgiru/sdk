...
; This file was generated Fri Jun 13 08:34:23 2014
;--------------------------------------------------------
...
_rtc2_configure_PARM_2:
	.ds 2
_rtc2_configure_rtc2_config_options_1_3:
	.ds 1
;--------------------------------------------------------
...
;rtc2_config_options       Allocated with name '_rtc2_configure_rtc2_config_options_1_3'
;------------------------------------------------------------
...
_rtc2_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rtc2_configure_rtc2_config_options_1_3
	movx	@dptr,a
...
;	src/rtc2_configure.c:57: ((rtc2_config_options & RTC2CON_COMPARE_MODE_MASK) == RTC2_CONFIG_OPTION_COMPARE_MODE_1_WRAP_AT_IRQ))
	...
	cjne	r6,#0x04,00102$
00101$:
;	src/rtc2_configure.c:59: rtc2_set_compare_val(compare_value);
	...
	mov	dph,r6
	push	ar7
	lcall	_rtc2_set_compare_val
	pop	ar7
00102$:
;	src/rtc2_configure.c:63: RTC2CON = (RTC2CON & ~RTC2_CONFIG_OPTION_RTC2CON_MASK) | (rtc2_config_options & RTC2_CONFIG_OPTION_RTC2CON_MASK);
	mov	r6,_RTC2CON
	anl	ar6,#0xF0
	anl	ar7,#0x0F
	mov	a,r7
