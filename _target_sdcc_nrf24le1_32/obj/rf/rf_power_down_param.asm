...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_power_down_param_config_1_31:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;config                    Allocated with name '_rf_power_down_param_config_1_31'
;------------------------------------------------------------
...
_rf_power_down_param:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_power_down_param_config_1_31
	movx	@dptr,a
...
;	src/rf_power_down_param.c:52: rf_write_register(RF_CONFIG, &config, 1);
	...
	mov	a,#_rf_power_down_param_config_1_31
	movx	@dptr,a
	mov	a,#(_rf_power_down_param_config_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
