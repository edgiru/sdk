...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_rx_fifo_is_empty_fifo_status_1_31:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;fifo_status               Allocated with name '_rf_rx_fifo_is_empty_fifo_status_1_31'
;------------------------------------------------------------
...
;	src/rf_rx_fifo_is_empty.c:51: rf_read_register(RF_FIFO_STATUS, &fifo_status, 1);
	...
	mov	a,#_rf_rx_fifo_is_empty_fifo_status_1_31
	movx	@dptr,a
	mov	a,#(_rf_rx_fifo_is_empty_fifo_status_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_rx_fifo_is_empty.c:53: return (fifo_status & RF_FIFO_STATUS_RX_EMPTY) ? true : false;
	mov	dptr,#_rf_rx_fifo_is_empty_fifo_status_1_31
	movx	a,@dptr
	mov	r7,a
	jnb	acc.0,00103$
	mov	r7,#0x01
