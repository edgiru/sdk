...
_rf_spi_send_read_PARM_3:
	.ds 1
_rf_spi_send_read_dataptr_1_31:
	.ds 3
;--------------------------------------------------------
...
;dataptr                   Allocated with name '_rf_spi_send_read_dataptr_1_31'
;i                         Allocated with name '_rf_spi_send_read_i_1_32'
;tempbyte                  Allocated with name '_rf_spi_send_read_tempbyte_1_32'
;------------------------------------------------------------
...
_rf_spi_send_read:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_spi_send_read_dataptr_1_31
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
