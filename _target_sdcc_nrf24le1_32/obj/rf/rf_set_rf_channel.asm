...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_set_rf_channel_channel_1_31:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_set_rf_channel'
;------------------------------------------------------------
;channel                   Allocated with name '_rf_set_rf_channel_channel_1_31'
;------------------------------------------------------------
;	src/rf_set_rf_channel.c:47: void rf_set_rf_channel(uint8_t channel)
;	-----------------------------------------
;	 function rf_set_rf_channel
;	-----------------------------------------
_rf_set_rf_channel:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_set_rf_channel_channel_1_31
	movx	@dptr,a
;	src/rf_set_rf_channel.c:49: if(channel <= RF_RF_CH_MAX_CHAN_NUM)
	movx	a,@dptr
	mov  r7,a
	add	a,#0xff - 0x7F
	jc	00103$
;	src/rf_set_rf_channel.c:51: rf_write_register(RF_RF_CH, &channel, 1);
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_set_rf_channel_channel_1_31
	movx	@dptr,a
	mov	a,#(_rf_set_rf_channel_channel_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
