...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_7:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;pwr_failure_config_options Allocated with name '_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_7'
;------------------------------------------------------------
...
_pwr_clk_mgmt_pwr_failure_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_7
	movx	@dptr,a
