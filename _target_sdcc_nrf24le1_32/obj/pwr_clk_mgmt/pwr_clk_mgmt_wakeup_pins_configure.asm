...
; This file was generated Sun Jul 20 08:45:45 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_7:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;wakeup_on_pin_config_options Allocated with name '_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_7'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:46: void pwr_clk_mgmt_wakeup_pins_configure(uint16_t wakeup_on_pin_config_options)
;	-----------------------------------------
...
_pwr_clk_mgmt_wakeup_pins_configure:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_7
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:49: WUOPC0 = wakeup_on_pin_config_options & 0xFF;
	mov	dptr,#_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_7
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	ar4,r6
	mov	_WUOPC0,r4
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:50: WUOPC1 = (wakeup_on_pin_config_options >> 8) & 0xFF;
	mov	ar6,r7
	mov	_WUOPC1,r6
	ret
	.area CSEG    (CODE)
