...
; This file was generated Sun Jul 20 08:45:44 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_7:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;divider                   Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_divider_1_7'
;i                         Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_i_1_7'
;cclk_freq_khz             Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_7'
;------------------------------------------------------------
...
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:50: uint16_t cclk_freq_khz = CCLK_MAX_FREQ_KHZ;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_7
	mov	a,#0x80
	movx	@dptr,a
	mov	a,#0x3E
	inc	dptr
