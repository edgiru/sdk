...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_memory_flash_erase_page_page_num_1_16:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;page_num                  Allocated with name '_memory_flash_erase_page_page_num_1_16'
;------------------------------------------------------------
...
_memory_flash_erase_page:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_memory_flash_erase_page_page_num_1_16
	movx	@dptr,a
