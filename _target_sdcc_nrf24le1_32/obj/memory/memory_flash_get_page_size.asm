...
;--------------------------------------------------------
	.module memory_flash_get_page_size
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _memory_flash_get_page_size_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_memory_flash_get_page_size_PARM_2:
	.ds 3
_memory_flash_get_page_size_page_num_1_14:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'memory_flash_get_page_size'
;------------------------------------------------------------
;page_size                 Allocated with name '_memory_flash_get_page_size_PARM_2'
;page_num                  Allocated with name '_memory_flash_get_page_size_page_num_1_14'
;------------------------------------------------------------
;	src/memory_flash_get_page_size.c:47: memory_flash_return_t memory_flash_get_page_size(uint8_t page_num, uint16_t * page_size)
;	-----------------------------------------
;	 function memory_flash_get_page_size
;	-----------------------------------------
_memory_flash_get_page_size:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_memory_flash_get_page_size_page_num_1_14
	movx	@dptr,a
;	src/memory_flash_get_page_size.c:50: if(page_num >= MEMORY_FLASH_NUM_PAGES)
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x24,00120$
00120$:
	jc	00102$
;	src/memory_flash_get_page_size.c:52: return MEMORY_FLASH_BAD_PARAMS;
	mov	dpl,#0x01
	ret
00102$:
;	src/memory_flash_get_page_size.c:56: if(page_num < MEMORY_FLASH_CODE_NUM_PAGES)
	cjne	r7,#0x20,00122$
00122$:
	jnc	00107$
;	src/memory_flash_get_page_size.c:58: (*page_size) = MEMORY_FLASH_CODE_PAGE_SIZE;
	...
	sjmp	00108$
00107$:
;	src/memory_flash_get_page_size.c:60: else if(page_num < (MEMORY_FLASH_CODE_NUM_PAGES + MEMORY_FLASH_NV_EXT_END_NUM_PAGES))
	cjne	r7,#0x22,00124$
00124$:
	jnc	00104$
;	src/memory_flash_get_page_size.c:62: (*page_size) = MEMORY_FLASH_NV_EXT_END_PAGE_SIZE;
	mov	dptr,#_memory_flash_get_page_size_PARM_2
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	sjmp	00108$
00104$:
;	src/memory_flash_get_page_size.c:66: (*page_size) = MEMORY_FLASH_NV_STD_END_PAGE_SIZE;
	mov	dptr,#_memory_flash_get_page_size_PARM_2
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__gptrput
00108$:
;	src/memory_flash_get_page_size.c:69: return MEMORY_FLASH_OK;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
