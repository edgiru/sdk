...
; This file was generated Sun Jul 20 08:46:48 2014
;--------------------------------------------------------
	.module delay_ms
...
;------------------------------------------------------------
;milliseconds              Allocated with name '_delay_ms_milliseconds_1_4'
;count                     Allocated with name '_delay_ms_count_1_5'
;------------------------------------------------------------
...
_delay_ms:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay_ms_milliseconds_1_4
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
