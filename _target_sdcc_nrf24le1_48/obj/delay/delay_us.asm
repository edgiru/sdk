...
; This file was generated Fri Jun 13 08:34:53 2014
;--------------------------------------------------------
	.module delay_us
...
;------------------------------------------------------------
;microseconds              Allocated with name '_delay_us_microseconds_1_4'
;count                     Allocated with name '_delay_us_count_1_5'
;------------------------------------------------------------
...
_delay_us:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay_us_microseconds_1_4
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
