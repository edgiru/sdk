...
; This file was generated Sun Jul 20 08:47:56 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rng_configure_rng_config_options_1_2:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;rng_config_options        Allocated with name '_rng_configure_rng_config_options_1_2'
;------------------------------------------------------------
...
_rng_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rng_configure_rng_config_options_1_2
	movx	@dptr,a
