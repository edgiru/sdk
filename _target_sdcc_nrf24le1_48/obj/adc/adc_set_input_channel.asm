...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_set_input_channel_adc_channel_1_5:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_channel               Allocated with name '_adc_set_input_channel_adc_channel_1_5'
;------------------------------------------------------------
...
_adc_set_input_channel:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_adc_set_input_channel_adc_channel_1_5
	movx	@dptr,a
