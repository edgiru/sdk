...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_7:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;clklf_config_options      Allocated with name '_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_7'
;------------------------------------------------------------
...
_pwr_clk_mgmt_clklf_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_7
	movx	@dptr,a
