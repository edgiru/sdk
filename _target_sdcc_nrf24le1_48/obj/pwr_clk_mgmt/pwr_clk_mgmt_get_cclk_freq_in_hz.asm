...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_7:
	.ds 4
;--------------------------------------------------------
...
;------------------------------------------------------------
;divider                   Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_divider_1_7'
;i                         Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_i_1_7'
;cclk_freq_hz              Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_7'
;------------------------------------------------------------
...
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:50: uint32_t cclk_freq_hz = CCLK_MAX_FREQ_HZ;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_7
	clr	a
	movx	@dptr,a
	mov	a,#0x24
	inc	dptr
