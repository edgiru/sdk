...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_crc'
;------------------------------------------------------------
;seed                      Allocated with name '_owi_crc_PARM_2'
;data                      Allocated with name '_owi_crc_data_1_47'
;i                         Allocated to registers r7 
;------------------------------------------------------------
;	src/owi_crc.c:47: uint8_t owi_crc(uint8_t data, uint8_t seed)
;	-----------------------------------------
;	 function owi_crc
;	-----------------------------------------
_owi_crc:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_crc_data_1_47
	movx	@dptr,a
;	src/owi_crc.c:51: for (i = 8; i; i--)
	mov	r7,#0x08
00105$:
;	src/owi_crc.c:53: if (((seed ^ data) & 0x01))
	mov	dptr,#_owi_crc_data_1_47
	movx	a,@dptr
	mov	r6,a
	...
	xrl	a,r5
	jnb	acc.0,00102$
;	src/owi_crc.c:55: seed ^= 0x18;
	mov	dptr,#_owi_crc_PARM_2
	mov	a,#0x18
	xrl	a,r5
	movx	@dptr,a
;	src/owi_crc.c:56: seed >>= 1;
	movx	a,@dptr
	clr	c
	rrc	a
	movx	@dptr,a
;	src/owi_crc.c:57: seed |= 0x80;
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x80
	orl	a,r6
