...
; This file was generated Sun Jul 20 08:47:19 2014
;--------------------------------------------------------
	.module owi_send_byte
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_send_byte_PARM_2:
	.ds 1
_owi_send_byte_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_send_byte'
;------------------------------------------------------------
;mask                      Allocated to registers r7 
;data                      Allocated with name '_owi_send_byte_PARM_2'
;owi_pin_id                Allocated with name '_owi_send_byte_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_send_byte.c:47: void owi_send_byte(gpio_pin_id_t owi_pin_id, uint8_t data)
;	-----------------------------------------
;	 function owi_send_byte
;	-----------------------------------------
_owi_send_byte:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_send_byte_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_send_byte.c:49: register uint8_t mask = 0x01;
	mov	r7,#0x01
;	src/owi_send_byte.c:52: do
	movx	a,@dptr
	mov	r6,a
	mov	r5,a
	...
	mov	r4,a
00104$:
;	src/owi_send_byte.c:56: if (mask & data)
	mov	a,r4
	anl	a,r7
	jz	00102$
;	src/owi_send_byte.c:58: owi_write_bit_1(owi_pin_id);
	mov	dpl,r5
	push	ar7
	push	ar6
	push	ar5
	...
	sjmp	00103$
00102$:
;	src/owi_send_byte.c:62: owi_write_bit_0(owi_pin_id);
	mov	dpl,r6
	push	ar7
	push	ar6
	push	ar5
	...
	pop	ar7
00103$:
;	src/owi_send_byte.c:65: mask <<= 1;
	mov	a,r7
	add	a,r7
;	src/owi_send_byte.c:67: while (mask);
	mov	r7,a
	jnz	00104$
	ret
	.area CSEG    (CODE)
