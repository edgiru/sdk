...
; This file was generated Sun Jul 20 08:47:44 2014
;--------------------------------------------------------
...
_rf_configure_debug_PARM_3:
	.ds 1
_rf_configure_debug_rx_1_31:
	.ds 1
_rf_configure_debug_config_1_32:
	.ds 1
_rf_configure_debug_en_aa_1_32:
	.ds 1
;--------------------------------------------------------
...
;rx                        Allocated with name '_rf_configure_debug_rx_1_31'
;config                    Allocated with name '_rf_configure_debug_config_1_32'
;en_aa                     Allocated with name '_rf_configure_debug_en_aa_1_32'
;------------------------------------------------------------
...
_rf_configure_debug:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_configure_debug_rx_1_31
	movx	@dptr,a
;	src/rf_configure_debug.c:54: config = RF_CONFIG_DEFAULT_VAL | RF_CONFIG_PWR_UP; //Set config to the default value of CONFIG with the PWR_UP bit set
	mov	dptr,#_rf_configure_debug_config_1_32
	mov	a,#0x0A
	movx	@dptr,a
...
;	src/rf_configure_debug.c:59: en_aa = RF_EN_AA_ENAA_P0;
	mov	dptr,#_rf_configure_debug_en_aa_1_32
	mov	a,#0x01
	movx	@dptr,a
	sjmp	00103$
00102$:
