...
_rf_read_rx_payload_PARM_2:
	.ds 2
_rf_read_rx_payload_dataptr_1_31:
	.ds 3
;--------------------------------------------------------
...
;dataptr                   Allocated with name '_rf_read_rx_payload_dataptr_1_31'
;------------------------------------------------------------
...
_rf_read_rx_payload:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_read_rx_payload_dataptr_1_31
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	src/rf_read_rx_payload.c:50: return rf_spi_execute_command(RF_R_RX_PAYLOAD, dataptr, len, true);
	mov	dptr,#_rf_read_rx_payload_dataptr_1_31
	movx	a,@dptr
	mov	r5,a
	inc	dptr
