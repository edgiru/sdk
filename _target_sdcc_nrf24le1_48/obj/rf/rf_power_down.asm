...
;------------------------------------------------------------
;config                    Allocated with name '_rf_power_down_config_1_31'
;------------------------------------------------------------
...
;	src/rf_power_down.c:53: rf_read_register(RF_CONFIG, &config, 1); //Read the current value of the CONFIG register
	...
	mov	a,#_rf_power_down_config_1_31
	movx	@dptr,a
	mov	a,#(_rf_power_down_config_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_power_down.c:56: if((config & RF_CONFIG_PWR_UP) == 0)
	mov	dptr,#_rf_power_down_config_1_31
	movx	a,@dptr
	mov	r7,a
	jb	acc.1,00102$
