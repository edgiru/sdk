...
; This file was generated Sun Jul 20 08:47:45 2014
;--------------------------------------------------------
...
_rf_configure_debug_lite_PARM_2:
	.ds 1
_rf_configure_debug_lite_rx_1_31:
	.ds 1
_rf_configure_debug_lite_config_1_32:
	.ds 1
;--------------------------------------------------------
...
;rx                        Allocated with name '_rf_configure_debug_lite_rx_1_31'
;config                    Allocated with name '_rf_configure_debug_lite_config_1_32'
;------------------------------------------------------------
...
_rf_configure_debug_lite:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_configure_debug_lite_rx_1_31
	movx	@dptr,a
...
;	src/rf_configure_debug_lite.c:55: config = 0;
	mov	dptr,#_rf_configure_debug_lite_config_1_32
	clr	a
	movx	@dptr,a
;	src/rf_configure_debug_lite.c:56: rf_write_register(RF_EN_AA, &config, 1); //Turn auto-acknowledge off
	...
	mov	a,#_rf_configure_debug_lite_config_1_32
	movx	@dptr,a
	mov	a,#(_rf_configure_debug_lite_config_1_32 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_configure_debug_lite.c:57: rf_write_register(RF_SETUP_RETR, &config, 1); //Turn auto-retransmit off
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_configure_debug_lite_config_1_32
	movx	@dptr,a
	mov	a,#(_rf_configure_debug_lite_config_1_32 >> 8)
	...
	mov	dpl,#0x04
	lcall	_rf_write_register
;	src/rf_configure_debug_lite.c:60: config = RF_CONFIG_DEFAULT_VAL; //Set config to the default value of the CONFIG register
	mov	dptr,#_rf_configure_debug_lite_config_1_32
	mov	a,#0x08
	movx	@dptr,a
;	src/rf_configure_debug_lite.c:63: rf_write_register(RF_RX_PW_P0, &p0_payload_width, 1);
	mov	dptr,#_rf_write_register_PARM_2
	...
	mov	dpl,#0x11
	lcall	_rf_write_register
;	src/rf_configure_debug_lite.c:66: if(rx != false)
	mov	dptr,#_rf_configure_debug_lite_rx_1_31
	movx	a,@dptr
	mov	r7,a
	jz	00102$
;	src/rf_configure_debug_lite.c:68: config |= RF_CONFIG_PRIM_RX;
	mov	dptr,#_rf_configure_debug_lite_config_1_32
	mov	a,#0x09
	movx	@dptr,a
00102$:
;	src/rf_configure_debug_lite.c:71: rf_power_up_param(true, config);
	mov	dptr,#_rf_configure_debug_lite_config_1_32
	movx	a,@dptr
