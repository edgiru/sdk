...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_power_up_rx_active_mode_1_37:
	.ds 1
_rf_power_up_config_1_38:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;rx_active_mode            Allocated with name '_rf_power_up_rx_active_mode_1_37'
;config                    Allocated with name '_rf_power_up_config_1_38'
;------------------------------------------------------------
...
_rf_power_up:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_power_up_rx_active_mode_1_37
	movx	@dptr,a
;	src/rf_power_up.c:52: rf_read_register(RF_CONFIG, &config, 1); //Get the current value of the CONFIG register
	...
	mov	a,#_rf_power_up_config_1_38
	movx	@dptr,a
	mov	a,#(_rf_power_up_config_1_38 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_power_up.c:55: rf_power_up_param(rx_active_mode, config);
	mov	dptr,#_rf_power_up_rx_active_mode_1_37
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_rf_power_up_config_1_38
	movx	a,@dptr
