...
_memory_flash_can_byte_be_written_without_page_erase_PARM_2:
	.ds 1
_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_25:
	.ds 1
;--------------------------------------------------------
...
;cur_flash_val             Allocated with name '_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_25'
;temp_val                  Allocated with name '_memory_flash_can_byte_be_written_without_page_erase_temp_val_1_26'
;------------------------------------------------------------
;	src/memory_flash_can_byte_be_written_without_erase.c:50: bool memory_flash_can_byte_be_written_without_page_erase(uint8_t cur_flash_val, uint8_t write_val)
;	-----------------------------------------
...
_memory_flash_can_byte_be_written_without_page_erase:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_25
	movx	@dptr,a
;	src/memory_flash_can_byte_be_written_without_erase.c:56: temp_val = cur_flash_val ^ write_val;
	...
	mov	a,r7
	xrl	a,r6
;	src/memory_flash_can_byte_be_written_without_erase.c:62: temp_val &= write_val;
	anl	a,r7
;	src/memory_flash_can_byte_be_written_without_erase.c:67: if(temp_val == 0)
	jnz	00102$
;	src/memory_flash_can_byte_be_written_without_erase.c:69: return true;
	mov	dpl,#0x01
	ret
00102$:
;	src/memory_flash_can_byte_be_written_without_erase.c:73: return false;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
