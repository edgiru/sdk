...
; This file was generated Fri Jun 13 08:36:14 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_uart_send_wait_for_complete_tx_data_1_10:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;tx_data                   Allocated with name '_uart_send_wait_for_complete_tx_data_1_10'
;------------------------------------------------------------
...
_uart_send_wait_for_complete:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_uart_send_wait_for_complete_tx_data_1_10
	movx	@dptr,a
