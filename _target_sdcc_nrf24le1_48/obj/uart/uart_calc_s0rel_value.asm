...
_uart_calc_s0rel_value_PARM_2:
	.ds 1
_uart_calc_s0rel_value_desired_baud_rate_1_14:
	.ds 4
;--------------------------------------------------------
...
;desired_baud_rate         Allocated with name '_uart_calc_s0rel_value_desired_baud_rate_1_14'
;------------------------------------------------------------
...
_uart_calc_s0rel_value:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_uart_calc_s0rel_value_desired_baud_rate_1_14
	mov	a,r7
	movx	@dptr,a
	mov	a,r6
	inc	dptr
