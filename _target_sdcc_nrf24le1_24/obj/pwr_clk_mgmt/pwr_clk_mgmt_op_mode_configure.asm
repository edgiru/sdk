...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_7:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;op_mode_config_options    Allocated with name '_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_7'
;------------------------------------------------------------
...
_pwr_clk_mgmt_op_mode_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_7
	movx	@dptr,a
