...
_interrupt_configure_ifp_PARM_2:
	.ds 1
_interrupt_configure_ifp_interrupt_ifp_input_1_3:
	.ds 1
;--------------------------------------------------------
...
;interrupt_ifp_input       Allocated with name '_interrupt_configure_ifp_interrupt_ifp_input_1_3'
;------------------------------------------------------------
...
_interrupt_configure_ifp:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_interrupt_configure_ifp_interrupt_ifp_input_1_3
	movx	@dptr,a
