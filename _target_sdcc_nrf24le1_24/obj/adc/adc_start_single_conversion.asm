...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_start_single_conversion_adc_channel_1_5:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_channel               Allocated with name '_adc_start_single_conversion_adc_channel_1_5'
;------------------------------------------------------------
...
_adc_start_single_conversion:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_adc_start_single_conversion_adc_channel_1_5
	movx	@dptr,a
