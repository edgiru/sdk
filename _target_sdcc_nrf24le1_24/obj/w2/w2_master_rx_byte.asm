...
_w2_master_rx_byte_PARM_2:
	.ds 1
_w2_master_rx_byte_rx_byte_1_20:
	.ds 3
;--------------------------------------------------------
...
;rx_byte                   Allocated with name '_w2_master_rx_byte_rx_byte_1_20'
;temp_w2con1               Allocated with name '_w2_master_rx_byte_temp_w2con1_1_21'
;------------------------------------------------------------
...
_w2_master_rx_byte:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_w2_master_rx_byte_rx_byte_1_20
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
