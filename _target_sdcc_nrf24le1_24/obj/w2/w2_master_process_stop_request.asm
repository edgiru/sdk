...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_process_stop_request_send_start_stop_conditions_1_20:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;send_start_stop_conditions Allocated with name '_w2_master_process_stop_request_send_start_stop_conditions_1_20'
;------------------------------------------------------------
...
_w2_master_process_stop_request:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_w2_master_process_stop_request_send_start_stop_conditions_1_20
	movx	@dptr,a
