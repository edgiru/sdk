...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_wait_for_byte_tx_or_rx_local_w2con1_1_20:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;local_w2con1              Allocated with name '_w2_wait_for_byte_tx_or_rx_local_w2con1_1_20'
;------------------------------------------------------------
...
00101$:
	jbc	_IRCON_SB_SPI_2WIRE,00118$
	sjmp	00101$
00118$:
;	src/w2_wait_for_byte_tx_or_rx.c:54: local_w2con1 = W2CON1;
	mov	dptr,#_w2_wait_for_byte_tx_or_rx_local_w2con1_1_20
	mov	a,_W2CON1
	movx	@dptr,a
