...
_w2_master_tx_byte_PARM_2:
	.ds 1
_w2_master_tx_byte_tx_data_1_20:
	.ds 1
;--------------------------------------------------------
...
;tx_data                   Allocated with name '_w2_master_tx_byte_tx_data_1_20'
;temp_w2con1               Allocated with name '_w2_master_tx_byte_temp_w2con1_1_21'
;------------------------------------------------------------
...
_w2_master_tx_byte:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_w2_master_tx_byte_tx_data_1_20
	movx	@dptr,a
