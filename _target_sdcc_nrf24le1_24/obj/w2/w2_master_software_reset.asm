...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_software_reset_w2con0_copy_1_23:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;w2con0_copy               Allocated with name '_w2_master_software_reset_w2con0_copy_1_23'
;------------------------------------------------------------
...
;	src/w2_master_software_reset.c:55: w2con0_copy = W2CON0;
	mov	dptr,#_w2_master_software_reset_w2con0_copy_1_23
	mov	a,_W2CON0
	movx	@dptr,a
