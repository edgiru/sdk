...
_w2_configure_PARM_2:
	.ds 1
_w2_configure_w2_config_options_1_20:
	.ds 2
;--------------------------------------------------------
...
;w2_config_options         Allocated with name '_w2_configure_w2_config_options_1_20'
;------------------------------------------------------------
...
_w2_configure:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_w2_configure_w2_config_options_1_20
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
