...
; This file was generated Sun Jul 20 08:43:55 2014
;--------------------------------------------------------
	.module pwm_stop
...
;------------------------------------------------------------
;pwm_channel               Allocated with name '_pwm_stop_pwm_channel_1_4'
;------------------------------------------------------------
;	src/pwm_stop.c:46: void pwm_stop(pwm_channel_t pwm_channel)
;	-----------------------------------------
;	 function pwm_stop
;	-----------------------------------------
_pwm_stop:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwm_stop_pwm_channel_1_4
	movx	@dptr,a
;	src/pwm_stop.c:49: if(pwm_channel == PWM_CHANNEL_0)
	movx	a,@dptr
	mov	r7,a
	jnz	00102$
;	src/pwm_stop.c:51: reg_bits_clear(PWMCON, PWMCON_PWM0_ENABLE);
	mov	r7,_PWMCON
	mov	a,#0xFE
	anl	a,r7
	mov	_PWMCON,a
	ret
00102$:
;	src/pwm_stop.c:55: reg_bits_clear(PWMCON, PWMCON_PWM1_ENABLE);
	mov	r7,_PWMCON
	mov	a,#0xFD
	anl	a,r7
	mov	_PWMCON,a
