...
; This file was generated Fri Jun 13 08:31:29 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_gpio_pin_val_read_gpio_pin_id_1_9:
	.ds 1
_gpio_pin_val_read_value_1_10:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;gpio_pin_id               Allocated with name '_gpio_pin_val_read_gpio_pin_id_1_9'
;value                     Allocated with name '_gpio_pin_val_read_value_1_10'
;------------------------------------------------------------
...
_gpio_pin_val_read:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_gpio_pin_val_read_gpio_pin_id_1_9
	movx	@dptr,a
;	src/gpio_pin_val_read.c:48: bool value = false;
	mov	dptr,#_gpio_pin_val_read_value_1_10
	clr	a
	movx	@dptr,a
