...
; This file was generated Fri Jun 13 08:32:35 2014
;--------------------------------------------------------
	.module rtc2_set_compare_val
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rtc2_set_compare_val_compare_value_1_3:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rtc2_set_compare_val'
;------------------------------------------------------------
;compare_value             Allocated with name '_rtc2_set_compare_val_compare_value_1_3'
;------------------------------------------------------------
;	src/rtc2_set_compare_val.c:46: void rtc2_set_compare_val(uint16_t compare_value)
;	-----------------------------------------
;	 function rtc2_set_compare_val
;	-----------------------------------------
_rtc2_set_compare_val:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_rtc2_set_compare_val_compare_value_1_3
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
;	src/rtc2_set_compare_val.c:48: RTC2CMP0 = (uint8_t)compare_value;
	mov	dptr,#_rtc2_set_compare_val_compare_value_1_3
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	r7,a
	mov	_RTC2CMP0,r6
;	src/rtc2_set_compare_val.c:49: RTC2CMP1 = (uint8_t)(compare_value >> 8);
	mov	_RTC2CMP1,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
