...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_check_rom'
;------------------------------------------------------------
;i                         Allocated to registers r3 
;crc                       Allocated to registers r7 
;ptr_rom                   Allocated with name '_owi_check_rom_ptr_rom_1_47'
;------------------------------------------------------------
;	src/owi_check_rom.c:47: uint8_t owi_check_rom(uint8_t * ptr_rom)
;	-----------------------------------------
;	 function owi_check_rom
;	-----------------------------------------
_owi_check_rom:
	ar7 = 0x07
	ar6 = 0x06
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_owi_check_rom_ptr_rom_1_47
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	src/owi_check_rom.c:50: register uint8_t crc = 0;
	mov	r7,#0x00
;	src/owi_check_rom.c:52: for (i = 7; i; i--)
	mov	dptr,#_owi_check_rom_ptr_rom_1_47
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	r3,#0x07
00104$:
;	src/owi_check_rom.c:54: crc = owi_crc(*ptr_rom, crc);
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	lcall	__gptrget
	...
	pop	ar5
	pop	ar6
;	src/owi_check_rom.c:55: ptr_rom++;
	mov	dptr,#_owi_check_rom_ptr_rom_1_47
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
...
;	src/owi_check_rom.c:52: for (i = 7; i; i--)
	djnz	r3,00104$
;	src/owi_check_rom.c:57: if (crc == (*ptr_rom))
	mov	dptr,#_owi_check_rom_ptr_rom_1_47
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	...
	mov	a,r7
	cjne	a,ar4,00103$
;	src/owi_check_rom.c:59: return OWI_CRC_OK;
	mov	dpl,#0x00
	ret
00103$:
;	src/owi_check_rom.c:61: return OWI_CRC_ERROR;
	mov	dpl,#0x01
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
