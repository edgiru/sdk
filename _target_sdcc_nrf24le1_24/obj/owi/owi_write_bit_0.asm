...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_write_bit_0_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_write_bit_0'
;------------------------------------------------------------
;owi_pin_id                Allocated with name '_owi_write_bit_0_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_write_bit_0.c:46: void owi_write_bit_0(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_write_bit_0
;	-----------------------------------------
_owi_write_bit_0:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_write_bit_0_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_write_bit_0.c:49: gpio_pin_dir_output(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_OUTPUT_BUFFER_NORMAL_DRIVE_STRENGTH);
	movx	a,@dptr
	mov	r7,a
...
;	src/owi_write_bit_0.c:50: delay_us(OWI_DELAY_C);
	mov	dptr,#0x0031
	lcall	_delay_us
	pop	ar7
;	src/owi_write_bit_0.c:53: gpio_pin_dir_input(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_INPUT_BUFFER_ON_PULL_UP_RESISTOR);
	mov	dptr,#_gpio_pin_dir_input_PARM_2
	mov	a,#0x40
	movx	@dptr,a
	mov	dpl,r7
	lcall	_gpio_pin_dir_input
;	src/owi_write_bit_0.c:54: delay_us(OWI_DELAY_D);
	mov	dptr,#0x0001
	ljmp	_delay_us
	.area CSEG    (CODE)
	.area CONST   (CODE)
