...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_skip_rom'
;------------------------------------------------------------
;owi_pin_id                Allocated with name '_owi_skip_rom_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_skip_rom.c:46: void owi_skip_rom(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_skip_rom
;	-----------------------------------------
_owi_skip_rom:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_skip_rom_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_skip_rom.c:49: owi_send_byte(owi_pin_id, OWI_SKIP_ROM);
	movx	a,@dptr
	mov	r7,a
