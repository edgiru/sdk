...
; This file was generated Sun Jul 20 08:43:50 2014
;--------------------------------------------------------
	.module owi_read_bit
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_read_bit'
;------------------------------------------------------------
;owi_pin_id                Allocated with name '_owi_read_bit_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_read_bit.c:46: uint8_t owi_read_bit(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_read_bit
;	-----------------------------------------
_owi_read_bit:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_read_bit_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_read_bit.c:49: gpio_pin_dir_output(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_OUTPUT_BUFFER_NORMAL_DRIVE_STRENGTH);
	movx	a,@dptr
	mov	r7,a
...
;	src/owi_read_bit.c:50: delay_us(OWI_DELAY_A);
	mov	dptr,#0x0001
	lcall	_delay_us
	pop	ar7
;	src/owi_read_bit.c:53: gpio_pin_dir_input(owi_pin_id, GPIO_PIN_CONFIG_OPTION_PIN_MODE_INPUT_BUFFER_ON_PULL_UP_RESISTOR);
...
;	src/owi_read_bit.c:54: delay_us(OWI_DELAY_E);
	mov	dptr,#0x0002
	lcall	_delay_us
	pop	ar7
;	src/owi_read_bit.c:57: if (gpio_pin_val_read(owi_pin_id))
	mov	dpl,r7
	lcall	_gpio_pin_val_read
	mov	a,dpl
	jz	00102$
;	src/owi_read_bit.c:59: delay_us(OWI_DELAY_F);
	mov	dptr,#0x002F
	lcall	_delay_us
;	src/owi_read_bit.c:60: return 1;
	mov	dpl,#0x01
	ret
00102$:
;	src/owi_read_bit.c:64: delay_us(OWI_DELAY_F);
	mov	dptr,#0x002F
	lcall	_delay_us
;	src/owi_read_bit.c:65: return 0;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
