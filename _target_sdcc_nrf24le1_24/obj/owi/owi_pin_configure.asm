...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_pin_configure_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_pin_configure'
;------------------------------------------------------------
;owi_pin_id                Allocated with name '_owi_pin_configure_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_pin_configure.c:46: void owi_pin_configure(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_pin_configure
;	-----------------------------------------
_owi_pin_configure:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_pin_configure_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_pin_configure.c:48: gpio_pin_configure(owi_pin_id, GPIO_PIN_CONFIG_OPTION_DIR_OUTPUT | GPIO_PIN_CONFIG_OPTION_OUTPUT_VAL_CLEAR | GPIO_PIN_CONFIG_OPTION_PIN_MODE_OUTPUT_BUFFER_NORMAL_DRIVE_STRENGTH);
	movx	a,@dptr
	mov	r7,a
	...
	pop	ar7
;	src/owi_pin_configure.c:49: gpio_pin_configure(owi_pin_id, GPIO_PIN_CONFIG_OPTION_DIR_INPUT | GPIO_PIN_CONFIG_OPTION_PIN_MODE_INPUT_BUFFER_ON_PULL_UP_RESISTOR);
	mov	dptr,#_gpio_pin_configure_PARM_2
	mov	a,#0x40
	movx	@dptr,a
	mov	dpl,r7
	lcall	_gpio_pin_configure
;	src/owi_pin_configure.c:52: delay_us(OWI_DELAY_H);
	mov	dptr,#0x01E0
	ljmp	_delay_us
	.area CSEG    (CODE)
	.area CONST   (CODE)
