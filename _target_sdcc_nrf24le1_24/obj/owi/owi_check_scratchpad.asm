...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_check_scratchpad_ptr_scratchpad_1_47:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_check_scratchpad'
;------------------------------------------------------------
;i                         Allocated to registers r3 
;crc                       Allocated to registers r7 
;ptr_scratchpad            Allocated with name '_owi_check_scratchpad_ptr_scratchpad_1_47'
;------------------------------------------------------------
;	src/owi_check_scratchpad.c:47: uint8_t owi_check_scratchpad(uint8_t * ptr_scratchpad)
;	-----------------------------------------
;	 function owi_check_scratchpad
;	-----------------------------------------
_owi_check_scratchpad:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_owi_check_scratchpad_ptr_scratchpad_1_47
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	src/owi_check_scratchpad.c:50: register uint8_t crc = 0;
	mov	r7,#0x00
;	src/owi_check_scratchpad.c:52: for (i = 8; i; i--)
	mov	dptr,#_owi_check_scratchpad_ptr_scratchpad_1_47
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	r3,#0x08
00104$:
;	src/owi_check_scratchpad.c:54: crc = owi_crc(*ptr_scratchpad, crc);
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	lcall	__gptrget
	...
	pop	ar5
	pop	ar6
;	src/owi_check_scratchpad.c:55: ptr_scratchpad++;
	mov	dptr,#_owi_check_scratchpad_ptr_scratchpad_1_47
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
...
;	src/owi_check_scratchpad.c:52: for (i = 8; i; i--)
	djnz	r3,00104$
;	src/owi_check_scratchpad.c:57: if (crc == (*ptr_scratchpad))
	mov	dptr,#_owi_check_scratchpad_ptr_scratchpad_1_47
	mov	a,r4
	movx	@dptr,a
	mov	a,r5
	...
	mov	a,r7
	cjne	a,ar4,00103$
;	src/owi_check_scratchpad.c:59: return OWI_CRC_OK;
	mov	dpl,#0x00
	ret
00103$:
;	src/owi_check_scratchpad.c:61: return OWI_CRC_ERROR;
	mov	dpl,#0x01
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
