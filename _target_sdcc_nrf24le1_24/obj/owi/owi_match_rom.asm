...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _owi_match_rom_PARM_2
	.globl _owi_match_rom
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_match_rom_PARM_2:
	.ds 3
_owi_match_rom_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_match_rom'
;------------------------------------------------------------
;i                         Allocated to registers r3 
;ptr_rom                   Allocated with name '_owi_match_rom_PARM_2'
;owi_pin_id                Allocated with name '_owi_match_rom_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_match_rom.c:47: void owi_match_rom(gpio_pin_id_t owi_pin_id, uint8_t * ptr_rom)
;	-----------------------------------------
;	 function owi_match_rom
;	-----------------------------------------
_owi_match_rom:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_match_rom_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_match_rom.c:52: owi_send_byte(owi_pin_id, OWI_MATCH_ROM);
	movx	a,@dptr
	mov	r7,a
	...
	pop	ar7
;	src/owi_match_rom.c:55: for (i = 8; i; i--)
	mov	dptr,#_owi_match_rom_PARM_2
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	movx	a,@dptr
	...
	mov	r3,#0x08
00102$:
;	src/owi_match_rom.c:58: owi_send_byte(owi_pin_id, *ptr_rom++);
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
	lcall	__gptrget
