...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_owi_receive_byte_owi_pin_id_1_47:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'owi_receive_byte'
;------------------------------------------------------------
;mask                      Allocated to registers r7 
;data                      Allocated to registers r6 
;owi_pin_id                Allocated with name '_owi_receive_byte_owi_pin_id_1_47'
;------------------------------------------------------------
;	src/owi_receive_byte.c:46: uint8_t owi_receive_byte(gpio_pin_id_t owi_pin_id)
;	-----------------------------------------
;	 function owi_receive_byte
;	-----------------------------------------
_owi_receive_byte:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_owi_receive_byte_owi_pin_id_1_47
	movx	@dptr,a
;	src/owi_receive_byte.c:49: register uint8_t mask = 0x01;
	mov	r7,#0x01
;	src/owi_receive_byte.c:50: register uint8_t data = 0x00;
	mov	r6,#0x00
;	src/owi_receive_byte.c:53: do
	movx	a,@dptr
	mov	r5,a
00103$:
;	src/owi_receive_byte.c:57: if (owi_read_bit(owi_pin_id))
	mov	dpl,r5
	push	ar7
	push	ar6
	push	ar5
	...
	pop	ar7
	jz	00102$
;	src/owi_receive_byte.c:60: data |= mask;
	mov	a,r7
	orl	ar6,a
00102$:
;	src/owi_receive_byte.c:63: mask <<= 1;
	mov	a,r7
	add	a,r7
;	src/owi_receive_byte.c:65: while (mask);
	mov	r7,a
	jnz	00103$
;	src/owi_receive_byte.c:66: return data;
	mov	dpl,r6
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
