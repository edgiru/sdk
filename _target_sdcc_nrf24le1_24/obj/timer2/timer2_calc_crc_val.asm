...
_timer2_calc_crc_val_PARM_2:
	.ds 1
_timer2_calc_crc_val_period_in_seconds_1_11:
	.ds 4
;--------------------------------------------------------
...
;period_in_seconds         Allocated with name '_timer2_calc_crc_val_period_in_seconds_1_11'
;calc_crc_val_f            Allocated with name '_timer2_calc_crc_val_calc_crc_val_f_1_12'
;------------------------------------------------------------
...
_timer2_calc_crc_val:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_timer2_calc_crc_val_period_in_seconds_1_11
	mov	a,r7
	movx	@dptr,a
	mov	a,r6
	inc	dptr
