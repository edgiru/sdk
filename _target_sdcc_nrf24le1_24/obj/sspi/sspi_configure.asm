...
; This file was generated Fri Jun 13 08:32:36 2014
;--------------------------------------------------------
	.module sspi_configure
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'sspi_configure'
;------------------------------------------------------------
;sspi_config_options       Allocated to registers r7 
;------------------------------------------------------------
;	src/sspi_configure.c:51: void sspi_configure(uint8_t sspi_config_options) __reentrant
;	-----------------------------------------
;	 function sspi_configure
;	-----------------------------------------
_sspi_configure:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	r7,dpl
;	src/sspi_configure.c:54: SPISCON0 = (SPISCON0 & ~SSPI_CONFIG_OPTION_SPISCON0_MASK) | (sspi_config_options & SSPI_CONFIG_OPTION_SPISCON0_MASK);
	mov	r6,_SPISCON0
	anl	ar6,#0x80
	anl	ar7,#0x7F
	mov	a,r7
