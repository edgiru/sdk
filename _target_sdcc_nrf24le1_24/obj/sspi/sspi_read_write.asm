...
; This file was generated Sun Jul 20 08:44:34 2014
;--------------------------------------------------------
	.module sspi_read_write
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'sspi_read_write'
;------------------------------------------------------------
;sspi_data                 Allocated to registers r7 
;------------------------------------------------------------
;	src/sspi_read_write.c:47: uint8_t sspi_read_write(uint8_t sspi_data) __reentrant
;	-----------------------------------------
;	 function sspi_read_write
;	-----------------------------------------
_sspi_read_write:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	r7,dpl
;	src/sspi_read_write.c:50: while(sspi_is_spi_slave_done(sspi_get_status()))
00101$:
	mov	a,_SPISSTAT
	jnb	acc.0,00103$
;	src/sspi_read_write.c:52: sspi_get_data();
	mov	a,_SPISDAT
	sjmp	00101$
00103$:
;	src/sspi_read_write.c:56: sspi_send_data(sspi_data);
	mov	_SPISDAT,r7
;	src/sspi_read_write.c:59: while(!sspi_is_spi_slave_done(sspi_get_status()));
00104$:
	mov	a,_SPISSTAT
	jnb	acc.0,00104$
;	src/sspi_read_write.c:62: return sspi_get_data();
	mov	dpl,_SPISDAT
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
