...
; This file was generated Fri Jun 13 08:32:30 2014
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_tx_fifo_is_empty_fifo_status_1_31:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;fifo_status               Allocated with name '_rf_tx_fifo_is_empty_fifo_status_1_31'
;------------------------------------------------------------
...
;	src/rf_tx_fifo_is_empty.c:51: rf_read_register(RF_FIFO_STATUS, &fifo_status, 1);
	...
	mov	a,#_rf_tx_fifo_is_empty_fifo_status_1_31
	movx	@dptr,a
	mov	a,#(_rf_tx_fifo_is_empty_fifo_status_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_tx_fifo_is_empty.c:53: return (fifo_status & RF_FIFO_STATUS_TX_EMPTY) ? true : false;
	mov	dptr,#_rf_tx_fifo_is_empty_fifo_status_1_31
	movx	a,@dptr
	mov	r7,a
	jnb	acc.4,00103$
	mov	r7,#0x01
