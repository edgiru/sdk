...
; This file was generated Sun Jul 20 08:44:26 2014
;--------------------------------------------------------
...
_rf_write_tx_payload_noack_PARM_3:
	.ds 1
_rf_write_tx_payload_noack_dataptr_1_31:
	.ds 3
;--------------------------------------------------------
...
;dataptr                   Allocated with name '_rf_write_tx_payload_noack_dataptr_1_31'
;status                    Allocated with name '_rf_write_tx_payload_noack_status_1_32'
;------------------------------------------------------------
...
_rf_write_tx_payload_noack:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_write_tx_payload_noack_dataptr_1_31
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
