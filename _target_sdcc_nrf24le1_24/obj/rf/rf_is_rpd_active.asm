...
; This file was generated Fri Jun 13 08:32:25 2014
;--------------------------------------------------------
	.module rf_is_rpd_active
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_is_rpd_active'
;------------------------------------------------------------
;rpd                       Allocated with name '_rf_is_rpd_active_rpd_1_31'
;------------------------------------------------------------
;	src/rf_is_rpd_active.c:47: bool rf_is_rpd_active()
;	-----------------------------------------
;	 function rf_is_rpd_active
;	-----------------------------------------
_rf_is_rpd_active:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rf_is_rpd_active.c:51: rf_read_register(RF_RPD, &rpd, 1);
	mov	dptr,#_rf_read_register_PARM_2
	mov	a,#_rf_is_rpd_active_rpd_1_31
	movx	@dptr,a
	mov	a,#(_rf_is_rpd_active_rpd_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_is_rpd_active.c:53: return (rpd & RF_RPD_RPD) ? true : false;
	mov	dptr,#_rf_is_rpd_active_rpd_1_31
	movx	a,@dptr
	mov	r7,a
	jnb	acc.0,00103$
	mov	r7,#0x01
