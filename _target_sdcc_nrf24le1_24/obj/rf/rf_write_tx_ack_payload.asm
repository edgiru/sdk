...
_rf_write_tx_ack_payload_PARM_2:
	.ds 2
_rf_write_tx_ack_payload_dataptr_1_31:
	.ds 3
;--------------------------------------------------------
...
;dataptr                   Allocated with name '_rf_write_tx_ack_payload_dataptr_1_31'
;status                    Allocated with name '_rf_write_tx_ack_payload_status_1_32'
;------------------------------------------------------------
...
_rf_write_tx_ack_payload:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_write_tx_ack_payload_dataptr_1_31
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
