...
; This file was generated Sun Jul 20 08:44:20 2014
;--------------------------------------------------------
	.module rf_read_register_1_byte
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_read_register_1_byte_regnumber_1_31:
	.ds 1
_rf_read_register_1_byte_reg_val_1_32:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_read_register_1_byte'
;------------------------------------------------------------
;regnumber                 Allocated with name '_rf_read_register_1_byte_regnumber_1_31'
;reg_val                   Allocated with name '_rf_read_register_1_byte_reg_val_1_32'
;------------------------------------------------------------
;	src/rf_read_register_1_byte.c:47: uint8_t rf_read_register_1_byte(uint8_t regnumber)
;	-----------------------------------------
;	 function rf_read_register_1_byte
;	-----------------------------------------
_rf_read_register_1_byte:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_read_register_1_byte_regnumber_1_31
	movx	@dptr,a
;	src/rf_read_register_1_byte.c:52: rf_read_register(regnumber, &reg_val, 1);
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_rf_read_register_PARM_2
	mov	a,#_rf_read_register_1_byte_reg_val_1_32
	movx	@dptr,a
	mov	a,#(_rf_read_register_1_byte_reg_val_1_32 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	src/rf_read_register_1_byte.c:54: return reg_val;
	mov	dptr,#_rf_read_register_1_byte_reg_val_1_32
	movx	a,@dptr
	mov	dpl,a
	ret
	.area CSEG    (CODE)
