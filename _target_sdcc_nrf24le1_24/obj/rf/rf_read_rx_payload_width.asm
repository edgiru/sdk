...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_read_rx_payload_width_dataptr_1_31:
	.ds 3
;--------------------------------------------------------
...
;------------------------------------------------------------
;dataptr                   Allocated with name '_rf_read_rx_payload_width_dataptr_1_31'
;status                    Allocated with name '_rf_read_rx_payload_width_status_1_32'
;------------------------------------------------------------
...
_rf_read_rx_payload_width:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_read_rx_payload_width_dataptr_1_31
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
