...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_irq_clear_all_dataptr_1_31:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;dataptr                   Allocated with name '_rf_irq_clear_all_dataptr_1_31'
;------------------------------------------------------------
...
;	src/rf_irq_clear_all.c:50: uint8_t dataptr = RF_STATUS_RX_DR | RF_STATUS_TX_DS | RF_STATUS_MAX_RT;
	mov	dptr,#_rf_irq_clear_all_dataptr_1_31
	mov	a,#0x70
	movx	@dptr,a
;	src/rf_irq_clear_all.c:52: rf_write_register(RF_STATUS, &dataptr, 1);
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_irq_clear_all_dataptr_1_31
	movx	@dptr,a
	mov	a,#(_rf_irq_clear_all_dataptr_1_31 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
