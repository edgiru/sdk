...
; This file was generated Sun Jul 20 08:44:22 2014
;--------------------------------------------------------
	.module rf_set_data_rate
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_set_data_rate_data_rate_1_31:
	.ds 1
_rf_set_data_rate_rf_setup_2_33:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_set_data_rate'
;------------------------------------------------------------
;data_rate                 Allocated with name '_rf_set_data_rate_data_rate_1_31'
;rf_setup                  Allocated with name '_rf_set_data_rate_rf_setup_2_33'
;------------------------------------------------------------
;	src/rf_set_data_rate.c:47: void rf_set_data_rate(uint8_t data_rate)
;	-----------------------------------------
;	 function rf_set_data_rate
;	-----------------------------------------
_rf_set_data_rate:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_set_data_rate_data_rate_1_31
	movx	@dptr,a
;	src/rf_set_data_rate.c:50: if ((data_rate == RF_RF_SETUP_RF_DR_250_KBPS) ||
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x20,00113$
	sjmp	00101$
00113$:
;	src/rf_set_data_rate.c:51: (data_rate == RF_RF_SETUP_RF_DR_1_MBPS) ||
	mov	a,r7
	jz	00101$
;	src/rf_set_data_rate.c:52: (data_rate == RF_RF_SETUP_RF_DR_2_MBPS)) {
	cjne	r7,#0x08,00105$
00101$:
;	src/rf_set_data_rate.c:54: uint8_t rf_setup = rf_read_register_1_byte(RF_RF_SETUP) & ~RF_RF_SETUP_RF_DR;
	mov	dpl,#0x06
	push	ar7
	...
	pop	ar7
	anl	ar6,#0xD7
	mov	dptr,#_rf_set_data_rate_rf_setup_2_33
	mov	a,r6
	movx	@dptr,a
;	src/rf_set_data_rate.c:55: rf_setup = (rf_setup & ~RF_RF_SETUP_RF_PWR) | data_rate;
	anl	ar6,#0xF9
	mov	dptr,#_rf_set_data_rate_rf_setup_2_33
	mov	a,r7
	orl	a,r6
	movx	@dptr,a
;	src/rf_set_data_rate.c:56: rf_write_register(RF_RF_SETUP, &rf_setup, 1);
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_set_data_rate_rf_setup_2_33
	movx	@dptr,a
	mov	a,#(_rf_set_data_rate_rf_setup_2_33 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
