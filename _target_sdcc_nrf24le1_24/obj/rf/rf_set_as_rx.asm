...
; This file was generated Sun Jul 20 08:44:21 2014
;--------------------------------------------------------
	.module rf_set_as_rx
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_set_as_rx_rx_active_mode_1_31:
	.ds 1
_rf_set_as_rx_config_1_32:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;rx_active_mode            Allocated with name '_rf_set_as_rx_rx_active_mode_1_31'
;config                    Allocated with name '_rf_set_as_rx_config_1_32'
;------------------------------------------------------------
...
;	src/rf_set_as_rx.c:54: if((config & RF_CONFIG_PRIM_RX) != RF_CONFIG_PRIM_RX)
	mov	dptr,#_rf_set_as_rx_config_1_32
	movx	a,@dptr
	mov	r7,a
	mov	a,#0x01
	anl	a,r7
	...
	sjmp	00102$
00119$:
;	src/rf_set_as_rx.c:57: config |= RF_CONFIG_PRIM_RX;
	mov	dptr,#_rf_set_as_rx_config_1_32
	mov	a,#0x01
	orl	a,r7
	movx	@dptr,a
;	src/rf_set_as_rx.c:58: rf_write_register(RF_CONFIG, &config, 1);
...
00102$:
;	src/rf_set_as_rx.c:62: if(rx_active_mode)
	mov	dptr,#_rf_set_as_rx_rx_active_mode_1_31
	movx	a,@dptr
	mov	r7,a
	jz	00106$
;	src/rf_set_as_rx.c:65: if(!rf_get_ce())
	jb	_RFCON_SB_RFCE,00108$
;	src/rf_set_as_rx.c:67: rf_set_ce();
	setb _RFCON_SB_RFCE 
	mov	dptr,#0x0004
	ljmp	_delay_us
00106$:
;	src/rf_set_as_rx.c:72: rf_clear_ce();
	clr _RFCON_SB_RFCE 
00108$:
	ret
	.area CSEG    (CODE)
