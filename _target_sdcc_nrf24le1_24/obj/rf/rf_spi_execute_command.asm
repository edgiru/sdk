...
; This file was generated Sun Jul 20 08:44:23 2014
;--------------------------------------------------------
...
_rf_spi_execute_command_PARM_4:
	.ds 1
_rf_spi_execute_command_instruction_1_31:
	.ds 1
_rf_spi_execute_command_status_1_32:
	.ds 1
;--------------------------------------------------------
...
;instruction               Allocated with name '_rf_spi_execute_command_instruction_1_31'
;status                    Allocated with name '_rf_spi_execute_command_status_1_32'
;------------------------------------------------------------
...
_rf_spi_execute_command:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_spi_execute_command_instruction_1_31
	movx	@dptr,a
;	src/rf_spi_execute_command.c:52: uint8_t status = instruction; //status writes the instruction, then reads the current STATUS value
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_rf_spi_execute_command_status_1_32
	movx	@dptr,a
