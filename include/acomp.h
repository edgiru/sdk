...
#define ACOMP_CONFIG_OPTION_REF_EXT_ON_AIN3			((ADC_CONFIG_OPTION_REF_SELECT_EXT_AIN3 << ACOMP_CONFIG_OPTION_ADCCON1_OFFSET_SHIFT) |\
													 (COMPCON_REF_SEL << ACOMP_CONFIG_OPTION_COMPCON_OFFSET_SHIFT))					//Set reference to external value on AIN3 or AIN9
#define ACOMP_CONFIG_OPTION_REF_EXT_ON_AIN9			((ADC_CONFIG_OPTION_REF_SELECT_EXT_AIN9 << ACOMP_CONFIG_OPTION_ADCCON1_OFFSET_SHIFT) |\
													 (COMPCON_REF_SEL << ACOMP_CONFIG_OPTION_COMPCON_OFFSET_SHIFT))					//Set reference to external value on AIN3 or AIN9
